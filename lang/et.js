export default {
  ...
  common: {
    ...
    drillcoresCount: 'Puursüdamikud: {count}',
    locality: 'Lokaliteet',
    localities: 'Lokaliteedid',
    localitiesCount: 'Lokaliteedid: {count}',
    sample: 'Proov',
    samples: 'Proovid',
    samplesCount: 'Proovid: {count}',
    analysis: 'Analüüs',
    analyses: 'Analüüsid',
    analysesCount: 'Analüüsid: {count}',
    sites: 'Vaatluspunktid',
    sitesCount: 'Vaatluspunktid: {count}',
    about: 'Tutvustus',
