export default {
  ...
  analysis: {
    ...
    sample_id: 'sample_id',
    lab_txt: 'lab_txt',
    analysis_method_en: 'analysis_method_en',
    specimen_id: 'specimen_id',
    agent_txt: 'agent_txt',
    longitude: 'longitude',
    instrument_en: 'instrument_en',
    lithostratigraphy_en: 'lithostratigraphy_en',
    method_details_en: 'method_details_en',
    dataset_id: 'dataset_id',
    latlong: 'latlong',
    depth_interval: 'depth_interval',
    lab_sample_number: 'lab_sample_number',
    date_end: 'date_end',
    id_sample_palaeontology: 'id_sample_palaeontology',
    analysis_method: 'analysis_method',
    instrument_txt: 'instrument_txt',
    date_added: 'date_added',
    lithostratigraphy_id: 'lithostratigraphy_id',
    stratigraphy_bed: 'stratigraphy_bed',
    lab_analysis_number: 'lab_analysis_number',
    site_id: 'site_id',
    name: 'name',
    user_changed: 'user_changed',
    is_private: 'is_private',
    ...
    timestamp: 'timestamp',
    analysed_parameters: 'analysed_parameters',
    sample_id_temp: 'sample_id_temp',
    acronym: 'acronym',
  ...
  specimen: {
    ...
    keywords: 'keywords',
    hierarchy_string_rock: 'hierarchy_string_rock',
    stratigraphy_hierarchy: 'stratigraphy_hierarchy',
    rock_txt_en: 'rock_txt_en',
    specimen_status: 'specimen_status',
    specimen_number_old: 'specimen_number_old',
    rock_txt: 'rock_txt',
    taxon_txt: 'taxon_txt',
    longitude: 'longitude',
    rock_id: 'rock_id',
    ...
    lithostratigraphy_en: 'lithostratigraphy_en',
    image_url: 'image_url',
    specimen_status_en: 'specimen_status_en',
    stratigraphy_txt: 'stratigraphy_txt',
    depth_interval: 'depth_interval',
    hierarchy_string_rock_str: 'hierarchy_string_rock_str',
    date_added: 'date_added',
    lithostratigraphy_id: 'lithostratigraphy_id',
    specimen_references: 'specimen_references',
    user_changed: 'user_changed',
    collector_full_name: 'collector_full_name',
    is_private: 'is_private',
    user_added: 'user_added',
    fossilgroup: 'fossilgroup',
    original_status_en: 'original_status_en',
    latitude: 'latitude',
    image_preview_url: 'image_preview_url',
    stratigraphy_en: 'stratigraphy_en',
    ...
    specimen_number_field: 'specimen_number_field',
    stratigraphy_id: 'stratigraphy_id',
    image_author: 'image_author',
    specimen_full_name: 'specimen_full_name',
    acronym: 'acronym',
    ...
    fossil_group_names: 'fossil_group_names',
    specimen_kind_en: 'specimen_kind_en',
  ...
  taxon: {
    ...
    lad_id: 'lad_id',
    lithostratigraphy: 'lithostratigraphy',
    global_stratigraphy_en: 'global_stratigraphy_en',
    longitude: 'longitude',
    parent_taxon: 'parent_taxon',
    in_estonia: 'in_estonia',
    lithostratigraphy_en: 'lithostratigraphy_en',
    src: 'src',
    global_stratigraphy: 'global_stratigraphy',
    latlong: 'latlong',
    country_en: 'country_en',
    taxon_id: 'taxon_id',
    global_stratigraphy_hierarchy: 'global_stratigraphy_hierarchy',
    fossil_group: 'fossil_group',
    in_baltoscandia: 'in_baltoscandia',
    coord_det_precision: 'coord_det_precision',
    locality_id: 'locality_id',
    fossil_group_id: 'fossil_group_id',
    _version_: '_version_',
    author_year: 'author_year',
    parent_id: 'parent_id',
    taxon_hierarchy: 'taxon_hierarchy',
  },
  infinite: {
    noMore: '',
    error: '',
