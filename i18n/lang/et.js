export default {
  ...
  common: {
    ...
    hideSimilar: "Peida tulemused",
    showSimilar: "Ava tulemused",
    similar: "Otsingutulemused",
    base: "Algus",
    top: "Lõpp",
    area: "Ala",
    locality: "Lokaliteet",
    ...
    drillcoreBox: "Puursüdamiku kast",
    specimen: "Eksemplar",
    stratigraphy: "Stratigraafia",
    file: "Fail",
    sample: "Proov",
  ...
  locality: {
    ...
    number: "Number",
    relatedReferences: "Kirjanduse viited",
    relatedSpecimens: "Eksemplarid",
    relatedSamples: "Proovid",
    relatedAnalyses: "Analüüsid",
    relatedDrillcores: "Puursüdamikud",
    relatedFiles: "Failid",
    relatedImages: "Pildid",
    relatedStratotypes: "Stratotüübid",
    relatedTaxonOccurrences: "Taksoni viited",
  },
  localitySynonym: {
    synonym: "Sünonüüm",
    pages: "Leheküljed",
  ...
  related: {
    collection: "Kollektsioonid",
    specimen: "Eksemplarid",
    sample: "Proovid",
    sample_series: "Prooviseeriad",
    analysis: "Analüüsid",
    dataset: "Andmesetid",
    doi: "DOI",
    ...
    site: "Uuringupunktid",
    storage: "Hoiukohad",
    locality_description: "Asukoha kirjeldused",
    taxon: "Taksonid",
  },
  collection: {
    collection: "Kollektsioon",
