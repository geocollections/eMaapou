...
const { data, status, refresh } = await useApiFetch<GeoloogiaListResponse>(`/samples/${route.params.id}/attachments/`, {
  query: computed(() => ({
...
const { exportData } = useExportApi(`/samples/${route.params.id}/attachments/`, {
