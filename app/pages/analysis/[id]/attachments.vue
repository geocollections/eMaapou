...
const { data, status, refresh } = await useApiFetch<GeoloogiaListResponse>(`/analyses/${route.params.id}/attachments/`, {
  query: computed(() => ({
...
const { exportData } = useExportApi(`/analyses/${route.params.id}/attachments/`, {
